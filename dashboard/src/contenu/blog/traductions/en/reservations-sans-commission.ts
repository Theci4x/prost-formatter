...
export const traduction: TraductionBillet = {
  slug: "commission-free-bookings-what-it-would-really-save-you",
  titre: "Commission-free bookings: what it would really save you",
  resume:
    "A commission per cover is not expensive in itself. It is expensive on the customers who would have come anyway. Here is how to work out your own figure, and when a subscription becomes the right choice — or does not.",
  essentiel: [
    "A commission of €1 to €2 per cover costs between €2,400 and €19,200 a year depending on volume. The sum is one multiplication, and it is worth doing.",
    "The real question is not the amount but the share: how many of those covers would have come without the platform. On those, the commission pays for visibility you already had.",
    "A subscription is not always the right sum. An empty room on a Tuesday in January justifies any commission: €18 of margin minus a bit beats €0.",
    "Before cutting anything, you need somewhere to send customers: a Google listing you look after, and a booking link in your own name pasted into it.",
  ],
  markdown: `
...
**A [Google listing](/blog/avis-google-restaurant-ce-qui-est-interdit) you look after.** It is your first shopfront, before your website. Exact hours, recent photos, the right category, reviews you reply to. An incomplete listing loses places in local results, therefore direct traffic — and mechanically makes you more dependent on the apps. That is the circle to break first.
...
When someone [asks ChatGPT, Gemini or Perplexity](/blog/pourquoi-chatgpt-ne-parle-pas-de-votre-restaurant) “where can six of us eat in the 11th”, the assistant does not return a list of results: **it chooses**. It names two or three places, and the others do not exist in that answer. There is no second page.

What decides who gets named resembles what decides local search, but is more demanding on consistency:

1. a complete, living Google listing, with recent reviews;
2. mentions somewhere other than your own site — local press, blogs, guides;
3. a site whose content a machine can read: hours, menu, type of cuisine, address;
4. structured data, saying explicitly “this is a restaurant” and not “this is a page”;
5. the same information everywhere — Google, TripAdvisor, Yelp, your site. An address differing by one line is enough to sow doubt.
...
1. **Find your platform volume** and multiply it. You now have an annual figure.
2. **Estimate the share of regulars** in that volume. That is your reserve.
3. **Look after your Google listing** and paste a booking link in your own name into it. There is no point cutting before that.
4. **Look at what the assistants answer** about your neighbourhood. If you are not in it, the direct channel will stay narrow whatever you do.
5. **Then cut back**, not before — and keep the marketplace for what it does well.
