...
export function LoginIllustration({ accroche }: { accroche: string }) {
  return (
    <div
      style={{
        position: "relative",
    ...
    >
      ...
      <FloatingIcon
        style={{ top: "18%", left: "20%", transform: "rotate(-12deg)" }}
      >
        <svg
          width="28"
          height="28"
      ...
      <FloatingIcon
        style={{ bottom: "22%", left: "16%", transform: "rotate(8deg)" }}
      >
        <svg
          width="26"
          height="26"
      ...
      <FloatingIcon
        style={{ top: "22%", right: "16%", transform: "rotate(10deg)" }}
      >
        <svg
          width="24"
          height="24"
