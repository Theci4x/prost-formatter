...
export function AuditResultCard({
  ...
  return (
    // Deux colonnes sur grand écran. À gauche ce qu'on regarde — la fiche,
    // le score, les trois piliers —, collé au défilement : il reste sous
    // les yeux pendant qu'on lit, à droite, ce qu'il faut en faire. Une
    // seule colonne sur téléphone et à l'impression, où l'ordre reste le
    // même : on reconnaît sa maison, on voit sa note, puis on lit la suite.
    <div className="audit-rapport grid gap-6 rounded-2xl border border-line bg-white p-6 shadow-sm sm:p-8 lg:grid-cols-12 lg:gap-10 lg:p-10 print:block print:rounded-none print:border-0 print:p-0 print:shadow-none">
      <div className="flex flex-col gap-6 lg:sticky lg:top-8 lg:col-span-5 lg:self-start print:mb-5">
        ...
        <div className="flex items-baseline gap-3">
          <span className="text-6xl font-bold leading-none tracking-tight text-ink lg:text-7xl">
            {audit.score}
          </span>
      ...
      <div className="flex flex-col gap-6 lg:col-span-7">
        ...
        <div className="flex flex-col gap-3 border-t border-stone-100 pt-5 lg:border-0 lg:pt-0">
          <h4 className="text-base font-semibold text-ink">{t.actionsTitre}</h4>
