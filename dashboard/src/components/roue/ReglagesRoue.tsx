    ...
    >
      ...
      <label className={label} htmlFor="roue-sous-titre">
        ...
        <input
          ...
          placeholder={t("Un lot à retirer lors de votre prochaine visite")}
          className={`${champ} max-w-md`}
        />
      </label>
      ...
      {state.ok && !state.error && (
        <p className="text-sm text-emerald-700">{t("Enregistré.")}</p>
      )}
