...
const zh: ClesAccueilPublic = {
  meta: {
    titre: "Klarr — 让餐厅一目了然",
    description:
      "谷歌商家资料、顾客评价、AI 回答中的曝光度和订位，全部集中在一处。不按每位客人抽成。",
  },
  nav: {
    fonctionnement: "运作方式",
    test: "检测我的谷歌曝光",
  ...
  hero: {
    ...
    titreFin: "。",
    chapo:
      "订位簿、官网、顾客评价和谷歌商家资料集中在一处。订金直接进入您的账户，不经我们之手。每一个数字都附有背后的原始数据，您可以自己核实。",
    ctaTest: "免费检测我的谷歌曝光",
    ctaEssai: "免费试用 Klarr",
  ...
  probleme: {
    surtitre: "问题所在",
    titre:
      "您是否见过后台显示「谷歌排名第一」，而顾客却要翻到第二页才找得到您？",
    ...
    cartes: [
      {
        titre: "原始数据",
        texte:
          "您的谷歌商家资料原样呈现，顾客评价一字不改，以及顾客询问「去哪儿吃」时 AI 给出的原话。同样的问题您也可以自己去问一遍，结果是一样的。",
      },
      {
        titre: "历史记录，不是说辞",
        texte:
  ...
  difference: {
    ...
    sans: "不使用",
    oui: [
      "谷歌商家资料、评价、社交账号和菜单集中在一处",
      "关键词来自分析，而不是凭感觉",
      "谷歌、Yelp、Tripadvisor 的评价统一汇总",
      "照片和菜单几次点击即可更新",
      "您保持自主，不依赖任何人",
    ],
    non: [
    ...
    points: [
      {
        titre: "以您自己名义的订位页面",
        texte:
          "一个属于您的网址，可以放在谷歌商家资料、Instagram 或 Facebook 主页上。顾客两次点击即可订位，无需注册账号。",
      },
      {
        titre: "一张桌，或者整个空间",
        texte:
    ...
    questions: [
      {
        question: "Klarr 是什么？",
        reponse:
          "Klarr 是面向独立餐厅和小型餐饮集团的管理平台，把谷歌商家资料、顾客评价、订位以及在 AI 回答中的曝光度集中在一起，且不按每位客人抽成。",
      },
      {
        question: "Klarr 多少钱？",
      ...
      {
        question: "Klarr 如何提升餐厅的谷歌曝光度？",
        reponse:
          "Klarr 把谷歌商家资料、顾客评价和社交账号汇总在同一个后台，显示餐厅真正能排上的关键词，跟踪顾客寻找餐厅时 AI 助手给出的回答，并在有新评价或评分变动时立即提醒。",
      },
      {
      ...
      },
      {
        ...
        reponse:
          "原始数据：谷歌商家资料的原样、顾客评价的原文，以及顾客寻找餐厅时 AI 助手给出的原话。每一次分析都带日期并长期保存，结果不好的也一样保存。",
      },
    ],
  },
  fondateur: {
    ...
    p1: "Klarr 由一位做了二十年餐饮的人打造。我们知道在两个餐市之间自己去查谷歌商家资料是什么滋味，知道被卖了一个与现实对不上的分数是什么滋味，也知道把时间耗在为打动投资人而非餐饮人设计的工具上是什么滋味。",
  ...
  editeur: {
    ...
    p1: "Klarr 由 EDIREF 运营，这是一家自 2008 年起专注于网站开发、优化与搜索排名的巴黎公司。很多人是和客户同时开始接触 SEO 的，而 Thomas Bavoil 和他的团队，早在谷歌商家资料还不叫这个名字的时候就在做了。",
  ...
  test: {
    surtitre: "免费，无附加条件",
    titre: "还不是客户？先检测一下您在谷歌上的曝光。",
    texte:
      "2 分钟内，我们分析您餐厅的谷歌商家资料，并免费发给您一份详细的曝光度评分。",
    bouton: "开始免费检测",
  },
  bientot: {
    surtitre: "即将上线",
